...
)
{
	if( percentage || coverage )
	{
		...
		if( percentage )
		{
			average = current_report_->percentage.average ;
			list = current_report_->percentages ;
		}
		else
		{
			average = current_report_->coverage.average ;
			list = current_report_->coverages ;
		}
